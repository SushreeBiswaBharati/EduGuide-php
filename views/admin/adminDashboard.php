    ...
    <div class="d-flex p-3 gap-3 vh-100">
        ...
        <div class="sidebar d-flex flex-column justify-content-between p-0 rounded-4" id="sidebar">
            ...
            <nav class="flex-grow-1 px-3 py-3 d-flex flex-column gap-2 fw-semibold">
                <a href="#" class="nav-link active"><small>🏡</small> <span>Dashboard</span></a>
                <a href="#" class="nav-link"><small>👤</small> <span>Manage Students</span></a>
                <a href="#" class="nav-link"><small>🔍</small> <span>Manage Tutors</span></a>
                <a href="#" class="nav-link"><small>📅</small> <span>All Bookings</span></a>
                <a href="#" class="nav-link"><small>⭐</small> <span>Manage Dropdowns</span></a>
                <a href="#" class="nav-link"><small>📢</small> <span>Complaints</span></a>
            </nav>
        ...
        <div class="flex-grow-1 main-content p-4 rounded-4 shadow-sm">
            ...
            <div class="mb-4 greet-bar rounded-4 p-4 text-white">
                ...
                <h4 class="fw-bold mb-1">Welcome Sushree! 🙋‍♀️</h4>
